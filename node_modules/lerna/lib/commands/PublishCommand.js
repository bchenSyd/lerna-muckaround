...
var PublishCommand = function (_Command) {
  ...
  _createClass(PublishCommand, [{
    ...
    value: function initialize(callback) {
      ...
      //#######################################################################################
        // check main loop; mainloop1; main loop1
    ...
    value: function execute(callback) {
      debugger; //second half; git commit; git push; mainloop; main loop; mainloop3
    ...
    value: function getVersionsForUpdates(callback) {
      ...
      if (conventionalCommits) {
        if (independentVersions) {
          ...
          //##########################################################################
                //     $argv2 is the real functor, wrapper to real bump function, search for 'real bump'/realbump
                //    /node_modules/lerna/lib/ConventionalCommitUtilities.js recommendVersion
